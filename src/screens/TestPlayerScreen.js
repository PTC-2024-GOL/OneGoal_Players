    ...
    return (
        <View style={[styles.textHorario]}>
            ...
            <TextInput
                ...
                editable={false} // Establece editable a false
                color='#000'
            />
        </View>
    );
...
const TestPlayerScreen = () => {
    ...
    const { idEntrenamiento } = route.params;
    ...
    const CARACTERISTICAS_API = 'services/players/caracteristicas.php';
    const NOTAS_API = 'services/players/caracteristicas_analisis.php';
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.subHeaderText}>
                Aquí podrás ver las notas obtenidas durante este entrenamiento
            </Text>
            {loading ? (
                <LoadingComponent />
            ) : (
