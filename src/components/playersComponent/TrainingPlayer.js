...
const TrainingPlayer = () => {
    ...
    const getProm = async () => {
        const DATA = await fetchData(API_PLAYERS, 'promByPlayerMobilePlayers');
    ...
    const getMatches = async () => {
        const DATA = await fetchData(API_PLAYERS, 'matchesByPlayeMobilePLayers');
    ...
    const getNotes = async ()=>{
        const DATA = await fetchData(API_PLAYERS, 'notesByPlayerMobilePlayers');
